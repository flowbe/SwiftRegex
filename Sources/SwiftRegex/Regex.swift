...
//  Regex.swift
//
//  Created by Florentin on 03/08/2020.
//  Copyright © 2020 Florentin. All rights reserved.
//
...
public struct Regex {
    ...
    */
    public func matches(in string: String, options: NSRegularExpression.MatchingOptions = [], range: Range<String.Index>) -> [[String]] {
    ...
    */
    public func firstMatch(in string: String, options: NSRegularExpression.MatchingOptions = []) -> [String] {
    ...
    - Returns: An array of matched strings. The first string contains the text that matches the full pattern, and the next ones contain the text matching the capturing groups.
    */
    public func firstMatch(in string: String, options: NSRegularExpression.MatchingOptions = [], range: Range<String.Index>) -> [String] {
        var matches = [String]()
    ...
    */
    public func rangeOfFirstMatch(in string: String, options: NSRegularExpression.MatchingOptions = []) -> Range<String.Index>? {
    ...
    */
    public func replaceMatches(in string: String, options: NSRegularExpression.MatchingOptions = [], with replacement: String) -> String {
    ...
    - Returns: A string with matching regular expressions replaced by the replacement string.
    */
    public func replaceMatches(in string: String, options: NSRegularExpression.MatchingOptions = [], range: Range<String.Index>, with replacement: String) -> String {
